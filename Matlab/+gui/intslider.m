...
classdef (Sealed) intslider < gui.labeledwidget
    ...
    methods
        function obj = intslider(labelStr, range, varargin)
    ...
    methods (Hidden)
        ...
        function propagateValueChange(obj)
            v = round(get(obj.UiControl, 'value'));
            set(obj.UiControl, 'value',v);
